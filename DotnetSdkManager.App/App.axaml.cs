...
using DotnetSdkManager.App.ViewModels;
using DotnetSdkManager.App.Views;
...
namespace DotnetSdkManager.App;
...
public partial class App : Application
{
    ...
    private static IServiceProvider BuildServices()
    {
        ...
        {
            DefaultRequestHeaders = { { "User-Agent", "DotnetSdkManager/1.0" } }
        });
...
#pragma warning disable CA1416
        ...
        else
        {
            throw new PlatformNotSupportedException(
                "DotnetSdkManager currently supports only Windows and Linux.");
        }
